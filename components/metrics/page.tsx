    ...
    return (
        <div className="bg-gradient-to-tr from-fg to-fpd w-full flex flex-col rounded items-center">
            <div className="w-full flex justify-around items-center"><Testimonials/></div>
                <div className="flex flex-col md:flex-row w-full md:w-[70%] h-fit text-white justify-between items-center p-[0px] md:p-[45px] mt-10">
                    ...
                    <div className="w-full md:w-[50%] flex flex-col justify-evenly md:items-start items-center md:mt-[0px] mt-10 md:mb-[0px] mb-5">
