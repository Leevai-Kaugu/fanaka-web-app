...
export default function Hero(){
    return(
        <div>
            ...
            <p className='text-white pt-[20px] w-[40%]'>Fanaka’s community-led financial innovation uplifts Zambia’s MSMEs especially women and youth owned ones. Advancing poverty eradication, economic equality, and sustainable growth. </p>
            <Contact_us/>
        </div>
    )
}