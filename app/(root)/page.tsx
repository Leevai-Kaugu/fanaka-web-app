   ...
   <Scroll>
      <div className='grid relative w-[100%] h-full'>         
        <Image
          ...
          width={1100}
          height={900}
          className="block md:hidden col-start-1 row-start-1 w-[100%] filter brightness-80 object-cover h-[100vh] md:h-[100vh] lg:h-[100vh] xl:h-[100vh] 2xl:h-[100vh] absolute top-0 left-0 z-0"
        />
        <Image
          src={background} // Home page background
          alt="Hero image"
          width={1100}
          height={900}
          className="hidden md:block col-start-1 row-start-1 w-[100%] filter brightness-80 object-cover h-[100vh] md:h-[100vh] lg:h-[100vh] xl:h-[100vh] 2xl:h-[100vh] absolute top-0 left-0 z-0"
        />
