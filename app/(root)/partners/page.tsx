      ...
      <div className='grid relative w-[100%] h-full'>         
        ...
        <div className="flex w-[100%] flex-col col-start-1 row-start-1 z-1">
          ...
          <div className="flex flex-col items-center justify-center mt-[10vh]">
            <div className="flex mb-[5vh] items-center justify-center">
                <div className="w-[40%]">
                    <h2 className="text-white text-[2vw] uppercase cursor-pointer hover:scale-105 transition-transform duration-300">Partner With Us</h2>
                    <p className="w-full text-white cursor-pointer hover:scale-105 transition-transform duration-300">At Fanaka, our vision is to revolutionize financial inclusion in Zambia and beyond, providing micro and small enterprises (MSMEs) with the tools and support they need to thrive. We aim to empower these enterprises by offering a holistic financial ecosystem, including financial literacy training, digital lending, and insurance linkages.</p>
                </div>
                <Image
                    ...
                    width={1100}
                    height={900}
                    className="col-start-1 row-start-1 w-[40%] cursor-pointer hover:scale-105 transition-transform duration-300 ease-in-out"
                />
            </div>
          </div>
          <Scroll>
            <div className="flex w-[100%] h-auto justify-around mt-[10vh] flex-col items-center">
              <h1 className="uppercase text-[2vw]">Our Partners</h1>
              <div className="w-full bg-flp p-10 flex mt-[5vh] gap-5 items-center justify-center">
                <Image
                    src={learn}
                    alt="Hero image"
                    width={1100}
                    height={900}
                    className="col-start-1 row-start-1 w-[7%] cursor-pointer hover:scale-105 transition-transform duration-300 ease-in-out"
                />
                <Image
                    src={bestlife}
                    alt="Hero image"
